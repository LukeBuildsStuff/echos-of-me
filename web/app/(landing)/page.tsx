...
export default function Home() {
  ...
  return (
    <>
      ...
      <section className="py-16 md:py-20 lg:py-28 bg-gradient-to-b from-white to-blue-50/30 dark:from-gray-dark dark:to-gray-dark">
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-3">
            ...
            <div className="wow fadeInUp group" data-wow-delay=".1s">
              <div className="relative overflow-hidden rounded-xl bg-white p-8 shadow-lg transition-all duration-300 hover:shadow-xl hover:-translate-y-1 dark:bg-gray-dark">
                ...
                <div className="relative">
                  <div className="mb-4 inline-flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-blue-100 to-blue-200 text-2xl">
                    👨‍👩‍👧‍👦
                  </div>
            ...
            <div className="wow fadeInUp group" data-wow-delay=".15s">
              <div className="relative overflow-hidden rounded-xl bg-white p-8 shadow-lg transition-all duration-300 hover:shadow-xl hover:-translate-y-1 dark:bg-gray-dark">
                ...
                <div className="relative">
                  <div className="mb-4 inline-flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-purple-100 to-purple-200 text-2xl">
                    👴👵
                  </div>
                  <h3 className="mb-3 text-xl font-bold text-black dark:text-white">
                    For Grandparents
            ...
            <div className="wow fadeInUp group" data-wow-delay=".2s">
              <div className="relative overflow-hidden rounded-xl bg-white p-8 shadow-lg transition-all duration-300 hover:shadow-xl hover:-translate-y-1 dark:bg-gray-dark">
                ...
                <div className="relative">
                  <div className="mb-4 inline-flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-amber-100 to-amber-200 text-2xl">
                    💕
                  </div>
                  <h3 className="mb-3 text-xl font-bold text-black dark:text-white">
                    For Every Family
      ...
      <section className="py-16 md:py-20 lg:py-28 bg-gradient-to-b from-purple-50/30 to-white dark:from-gray-dark dark:to-gray-dark">
        <div className="container">
