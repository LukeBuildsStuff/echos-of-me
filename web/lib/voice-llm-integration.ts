    ...
    for (const row of responses.rows) {
      ...
      trainingExamples.push({
        ...
        metadata: {
          ...
          integrationFeatures: {
            hasVoiceData: true,
            voiceQuality: voiceProfile.qualityScore,
            emotionalAlignment: voiceCharacteristics.emotionalRange,
            personalityConsistency: voiceCharacteristics.consistency
          }
        }
      })
    }
      ...
      if (passage.transcript) {
        examples.push({
          ...
          metadata: {
            ...
            voiceCharacteristics: passage.quality,
            integrationFeatures: {
              hasVoiceData: true,
              voiceQuality: passage.quality.overall,
              emotionalAlignment: passage.quality.emotionalRange,
              personalityConsistency: passage.quality.consistency,
              isVoicePassage: true,
