...
import { lazy, ComponentType, LazyExoticComponent, ReactNode } from 'react'
...
export const AdminModuleLoader = ({ message = 'Loading admin module...' }: { message?: string }): ReactNode => (
...
export const AdminModuleError = ({ error, resetErrorBoundary }: { error: Error, resetErrorBoundary: () => void }): ReactNode => (
...
export function createLazyAdminComponent<T extends ComponentType<any>>(
  ...
  const WrappedComponent = (props: any): ReactNode => (
    <ErrorBoundary
...
export class AdminComponentPreloader {
  ...
  static preloadCriticalComponents() {
    ...
    setTimeout(() => {
      ...
      // Preload settings and security components for likely navigation
      this.preloadComponent(
    ...
    // Preload secondary components after 3 seconds
    setTimeout(() => {
      this.preloadComponent(
