...
const adminNavItems: AdminNavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        icon: Heart,
        href: '/admin/families/support',
      },
      {
        id: 'family-analytics',
        label: 'Legacy Insights',
        icon: BarChart3,
        href: '/admin/families/analytics',
      },
      {
        id: 'crisis-support',
  ...
  {
    id: 'training',
    label: 'AI Legacy Nurturing',
    icon: Flower,
    children: [
      {
        id: 'training-overview',
        label: 'AI Echo Training',
        icon: Heart,
        href: '/admin/training',
  ...
  {
    id: 'error-monitoring',
    label: 'Family Guardian Monitoring',
    icon: Shield,
    children: [
      {
        ...
        badge: { text: 'Live', variant: 'default', pulse: true }
      },
      {
        id: 'crisis-alerts',
        label: 'Crisis Alert System',
        icon: AlertTriangle,
        href: '/admin/error-monitoring#crisis',
        badge: { text: '0', variant: 'default' }
      },
      {
        ...
        icon: MessageSquare,
        href: '/admin/error-monitoring#communication',
        badge: { text: 'Ready', variant: 'secondary' }
      },
      {
        id: 'error-resolution',
        label: 'Resolution Tracking',
        icon: Heart,
        href: '/admin/error-monitoring#resolution',
      },
      {
        id: 'error-recovery',
        label: 'Error Recovery',
        icon: TreePine,
        href: '/admin/error-recovery',
      }
    ]
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      {
        id: 'security-privacy',
        label: 'Family Privacy Settings',
        icon: Lock,
        href: '/admin/security/privacy',
      },
      {
        id: 'security-audit',
        label: 'Safe Access Logs',
        icon: FileText,
    ...
    <div className={cn("w-80 bg-white border-r border-gray-200 flex flex-col", className)}>
      ...
      <div className="p-4 border-b border-gray-200">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h2 className="font-semibold text-gray-900">Family Legacy Guardian</h2>
            <p className="text-xs text-gray-500">Compassionate Care Center</p>
          </div>
        </div>
