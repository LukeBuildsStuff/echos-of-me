...
export default function DailyQuestionPage() {
  ...
  return (
    <div id="main-content" className="mobile-min-vh-fix bg-gradient-to-br from-hope-50 via-white to-comfort-50 flex items-center justify-center p-4 sm:p-6 lg:p-8 safe-area">
      <div className="max-w-2xl w-full mx-auto">
        <Card className="bg-white/90 backdrop-blur border-comfort-200 shadow-xl hover:shadow-2xl transition-all duration-500">
          <CardHeader className="text-center space-y-4 px-4 sm:px-6">
            <div className="text-4xl sm:text-5xl" role="img" aria-label="sunrise">🌅</div>
          ...
          <CardContent className="space-y-4 sm:space-y-6 px-4 sm:px-6">
            ...
            <div className="space-y-3">
              <label 
                ...
                className="text-sm sm:text-base font-compassionate text-peace-700 block"
              >
              ...
              <Textarea
                ...
                className="min-h-32 sm:min-h-40 md:min-h-48 border-comfort-200 focus:border-comfort-400 bg-white/80 transition-all duration-300 focus:shadow-lg focus:bg-white/95 text-sm sm:text-base md:text-lg p-3 sm:p-4 touch-manipulation"
                rows={6}
                aria-describedby="word-count response-quality"
              />
              <div 
                id="word-count" 
                className="text-xs text-peace-500 text-right font-supportive"
                aria-live="polite"
              >
